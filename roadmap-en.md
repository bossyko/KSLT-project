...
- [x] Notification preferences: opt-out by 4 categories × 2 channels (TG + Email)
...
- [x] Dashboard: 12 stat cards + 6 activity tables + challenges card
...
- [x] Membership creation: profile search (profiles + players), period presets (1/3/6/12 months), 0 KGS with mandatory note
...
### Challenge Board ✅
- [x] SQL: challenges table + RLS + RPC + pg_cron expire (72h)
...
- [x] Meta tags in all 80 HTML files (manifest, theme-color, apple-touch-icon)
- [x] Installable on desktop (Chrome) + mobile (Android/iOS)

## Phase 6 — Documentation ✅

- [x] Technical docs (docs/TECHNICAL.md + docs/TECHNICAL-EN.md)
- [x] Manager guide v6.0 (docs/MANAGER-GUIDE.md + docs/MANAGER-GUIDE-EN.md)
...
- [x] Split admin.js (15,000+ lines) into 18 modular files (js/admin/)
- [x] Shared namespace window.KSLT_ADMIN, consolidated utilities
- [x] Tab consolidation: 13 tabs with sub-tabs
...
- [x] Rectangular photo with accent border (140x180px)
...
- [x] Edge Function: battle-publish — JWT auth, TG announcement with inline voting buttons
- [x] Telegram webhook: handleBattleVote — vote via inline buttons, show % after vote
...
- [x] Playwright setup (9 test suites, 3 viewports: desktop/tablet/mobile)
- [x] Page loading: all 80 pages (RU/EN/KG) — HTTP 200, no JS errors
- [x] Navigation: header links, language switcher, footer
- [x] Responsive: horizontal overflow check (5 breakpoints x 9 pages)
