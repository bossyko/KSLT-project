...
const ОТКАТЫ = [
  ...
  /* ПЕРЕЯКОРЕНО 24.09: эмодзи-сердце заменено значком, а якорь держался на
     самом эмодзи. Держимся за обёртку, которая и несёт aria-hidden. */
  ['partials/footer-ru.html',
   'Сделано с <span aria-hidden="true">',
   'Сделано с <span>',
   'ru: эмодзи скрыты от читалки'],
