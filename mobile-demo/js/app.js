...
(function() {
  ...
  function showOnboarding() {
    ...
    var steps = [
      { icon: '🎾', title: 'Добро пожаловать!', text: 'KSLT — теннисное сообщество Кыргызстана. Рейтинги, турниры и баттлы в одном приложении.' },
      { icon: '🏆', title: 'Турниры и рейтинг', text: 'Участвуйте в турнирах, поднимайтесь в рейтинге и бросайте вызов другим игрокам.' },
      { icon: '⭐', title: 'Оформите членство', text: 'Члены KSLT получают полный доступ: турниры, вызовы, скидки и баллы лояльности.' }
    ];
    ...
    function renderStep() {
      ...
      overlay.innerHTML =
        '<div class="onb-card">' +
          ...
          '<button class="onb-skip" id="onbSkip">Пропустить</button>' +
        '</div>';
