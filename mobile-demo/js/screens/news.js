...
(function() {
  ...
  function render() {
    ...
    if (filtered.length === 0) {
      el.innerHTML = '<div class="empty-state"><div class="empty-icon">📰</div><div class="empty-title">Нет новостей</div><div class="empty-text">' +
        (currentSearch ? 'По запросу ничего не найдено' : 'По выбранному фильтру новости не найдены') + '</div></div>';
      return;
    }
