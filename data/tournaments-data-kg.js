// ========================================
// TOURNAMENTS DATA (KG) - Replace with API later
// ========================================
...
const tournamentsData = {
    ...
    upcoming: {
        promasters: [
            { id: 1, name: 'KSLT Pro-Masters Championship', date: { day: '10', month: 'Мар' }, location: 'Бишкек, Tennis Palace', time: '09:00 - 20:00', format: 'Жалгыз', participants: '16/32', prize: '100,000 сом', status: 'open', image: 'https://images.unsplash.com/photo-1622279457486-62dcc4a431d6?w=800&q=80' },
            { id: 2, name: 'Spring Pro-Masters Open', date: { day: '24', month: 'Мар' }, location: 'Бишкек, Elite Courts', time: '10:00 - 19:00', format: 'Жалгыз', participants: '8/16', prize: '50,000 сом', status: 'open', image: 'https://images.unsplash.com/photo-1554068865-24cecd4e34b8?w=800&q=80' },
            { id: 3, name: 'Pro-Masters Doubles Cup', date: { day: '07', month: 'Апр' }, location: 'Бишкек, Асанбай', time: '10:00 - 18:00', format: 'Жуптук', participants: '6/16 жуп', prize: '60,000 сом', status: 'open', image: 'https://images.unsplash.com/photo-1595435934249-5df7ed86e1c0?w=800&q=80' },
            { id: 4, name: 'April Pro-Masters Grand', date: { day: '21', month: 'Апр' }, location: 'Бишкек, Central Court', time: '09:00 - 20:00', format: 'Жалгыз', participants: '0/32', prize: '120,000 сом', status: 'soon', image: 'https://images.unsplash.com/photo-1551773188-d63e5b03c7ce?w=800&q=80' },
            { id: 5, name: 'Pro-Masters Mixed Invitational', date: { day: '05', month: 'Май' }, location: 'Бишкек, Tennis Park', time: '10:00 - 19:00', format: 'Аралаш', participants: '0/16 жуп', prize: '40,000 сом', status: 'soon', image: 'https://images.unsplash.com/photo-1560012057-4372e14c5085?w=800&q=80' },
            { id: 6, name: 'May Pro-Masters Classic', date: { day: '19', month: 'Май' }, location: 'Бишкек, Ахунбаева 165', time: '09:00 - 20:00', format: 'Жалгыз', participants: '0/32', prize: '80,000 сом', status: 'soon', image: 'https://images.unsplash.com/photo-1530915534664-4ac6423816b7?w=800&q=80' },
            { id: 7, name: 'Summer Pro-Masters Open', date: { day: '02', month: 'Июн' }, location: 'Бишкек, Elite Courts', time: '08:00 - 21:00', format: 'Жалгыз', participants: '0/64', prize: '150,000 сом', status: 'soon', image: 'https://images.unsplash.com/photo-1587280501635-68a0e82cd5ff?w=800&q=80' },
            { id: 8, name: 'Pro-Masters Doubles Championship', date: { day: '16', month: 'Июн' }, location: 'Бишкек, Tennis Palace', time: '10:00 - 19:00', format: 'Жуптук', participants: '0/16 жуп', prize: '70,000 сом', status: 'soon', image: 'https://images.unsplash.com/photo-1542144582-1ba00456b5e3?w=800&q=80' }
        ],
        masters: [
            { id: 1, name: 'KSLT Masters Series #1', date: { day: '08', month: 'Мар' }, location: 'Бишкек, Central Court', time: '09:00 - 18:00', format: 'Жалгыз', participants: '28/32', prize: '40,000 сом', status: 'open', image: 'https://images.unsplash.com/photo-1551773188-d63e5b03c7ce?w=800&q=80' },
            { id: 2, name: 'Masters Doubles Cup', date: { day: '22', month: 'Мар' }, location: 'Бишкек, Асанбай', time: '10:00 - 17:00', format: 'Жуптук', participants: '10/16 жуп', prize: '30,000 сом', status: 'open', image: 'https://images.unsplash.com/photo-1595435934249-5df7ed86e1c0?w=800&q=80' },
            { id: 3, name: 'April Masters Championship', date: { day: '05', month: 'Апр' }, location: 'Бишкек, Tennis Park', time: '08:00 - 20:00', format: 'Жалгыз', participants: '0/64', prize: '60,000 сом', status: 'soon', image: 'https://images.unsplash.com/photo-1622279457486-62dcc4a431d6?w=800&q=80' },
            { id: 4, name: 'Masters Mixed Doubles', date: { day: '19', month: 'Апр' }, location: 'Бишкек, Джал', time: '10:00 - 18:00', format: 'Аралаш', participants: '0/16 жуп', prize: '25,000 сом', status: 'soon', image: 'https://images.unsplash.com/photo-1554068865-24cecd4e34b8?w=800&q=80' },
            { id: 5, name: 'KSLT Masters Series #2', date: { day: '03', month: 'Май' }, location: 'Бишкек, Ахунбаева 165', time: '09:00 - 18:00', format: 'Жалгыз', participants: '0/32', prize: '40,000 сом', status: 'soon', image: 'https://images.unsplash.com/photo-1560012057-4372e14c5085?w=800&q=80' },
            { id: 6, name: 'May Masters Doubles Open', date: { day: '17', month: 'Май' }, location: 'Бишкек, Central Court', time: '10:00 - 17:00', format: 'Жуптук', participants: '0/16 жуп', prize: '35,000 сом', status: 'soon', image: 'https://images.unsplash.com/photo-1530915534664-4ac6423816b7?w=800&q=80' },
            { id: 7, name: 'Masters Grand Cup', date: { day: '07', month: 'Июн' }, location: 'Бишкек, Tennis Palace', time: '08:00 - 20:00', format: 'Жалгыз', participants: '0/64', prize: '80,000 сом', status: 'soon', image: 'https://images.unsplash.com/photo-1587280501635-68a0e82cd5ff?w=800&q=80' },
            { id: 8, name: 'Summer Masters Classic', date: { day: '21', month: 'Июн' }, location: 'Бишкек, Elite Courts', time: '09:00 - 19:00', format: 'Жалгыз', participants: '0/32', prize: '50,000 сом', status: 'soon', image: 'https://images.unsplash.com/photo-1542144582-1ba00456b5e3?w=800&q=80' }
        ],
        challenger: [
            { id: 1, name: 'Challenger Cup Spring', date: { day: '01', month: 'Мар' }, location: 'Бишкек, Борбордук корт', time: '09:00 - 18:00', format: 'Жалгыз', participants: '30/32', prize: '25,000 сом', status: 'open', image: 'https://images.unsplash.com/photo-1595435934249-5df7ed86e1c0?w=800&q=80' },
            { id: 2, name: 'Challenger Doubles', date: { day: '15', month: 'Мар' }, location: 'Бишкек, Джал', time: '10:00 - 17:00', format: 'Жуптук', participants: '12/16 жуп', prize: '20,000 сом', status: 'open', image: 'https://images.unsplash.com/photo-1554068865-24cecd4e34b8?w=800&q=80' },
            { id: 3, name: 'March Challenger Open', date: { day: '29', month: 'Мар' }, location: 'Бишкек, Ахунбаева', time: '09:00 - 18:00', format: 'Жалгыз', participants: '0/32', prize: '30,000 сом', status: 'soon', image: 'https://images.unsplash.com/photo-1622279457486-62dcc4a431d6?w=800&q=80' },
            { id: 4, name: 'Challenger Mixed Cup', date: { day: '12', month: 'Апр' }, location: 'Бишкек, Асанбай', time: '10:00 - 18:00', format: 'Аралаш', participants: '0/16 жуп', prize: '18,000 сом', status: 'soon', image: 'https://images.unsplash.com/photo-1560012057-4372e14c5085?w=800&q=80' },
            { id: 5, name: 'April Challenger Championship', date: { day: '26', month: 'Апр' }, location: 'Бишкек, Tennis Park', time: '09:00 - 19:00', format: 'Жалгыз', participants: '0/32', prize: '28,000 сом', status: 'soon', image: 'https://images.unsplash.com/photo-1551773188-d63e5b03c7ce?w=800&q=80' },
            { id: 6, name: 'Challenger Doubles Open', date: { day: '10', month: 'Май' }, location: 'Бишкек, Central Court', time: '10:00 - 17:00', format: 'Жуптук', participants: '0/16 жуп', prize: '22,000 сом', status: 'soon', image: 'https://images.unsplash.com/photo-1530915534664-4ac6423816b7?w=800&q=80' },
            { id: 7, name: 'May Challenger Series', date: { day: '24', month: 'Май' }, location: 'Бишкек, Джал', time: '09:00 - 18:00', format: 'Жалгыз', participants: '0/32', prize: '25,000 сом', status: 'soon', image: 'https://images.unsplash.com/photo-1587280501635-68a0e82cd5ff?w=800&q=80' },
            { id: 8, name: 'Summer Challenger Grand', date: { day: '14', month: 'Июн' }, location: 'Бишкек, Ахунбаева 165', time: '08:00 - 20:00', format: 'Жалгыз', participants: '0/64', prize: '35,000 сом', status: 'soon', image: 'https://images.unsplash.com/photo-1542144582-1ba00456b5e3?w=800&q=80' }
        ],
        futures: [
            { id: 1, name: 'Futures Start Cup', date: { day: '20', month: 'Фев' }, location: 'Бишкек, Ахунбаева 165', time: '10:00 - 17:00', format: 'Жалгыз', participants: '20/24', prize: '10,000 сом', status: 'open', image: 'https://images.unsplash.com/photo-1560012057-4372e14c5085?w=800&q=80' },
            { id: 2, name: 'Futures Junior Open', date: { day: '06', month: 'Мар' }, location: 'Бишкек, Асанбай', time: '09:00 - 16:00', format: 'Жалгыз', participants: '15/24', prize: '8,000 сом', status: 'open', image: 'https://images.unsplash.com/photo-1554068865-24cecd4e34b8?w=800&q=80' },
            { id: 3, name: 'Spring Futures Championship', date: { day: '20', month: 'Мар' }, location: 'Бишкек, Tennis Park', time: '09:00 - 18:00', format: 'Жалгыз', participants: '0/32', prize: '15,000 сом', status: 'soon', image: 'https://images.unsplash.com/photo-1622279457486-62dcc4a431d6?w=800&q=80' },
            { id: 4, name: 'Futures Doubles Cup', date: { day: '03', month: 'Апр' }, location: 'Бишкек, Джал', time: '10:00 - 17:00', format: 'Жуптук', participants: '0/16 жуп', prize: '6,000 сом', status: 'soon', image: 'https://images.unsplash.com/photo-1595435934249-5df7ed86e1c0?w=800&q=80' },
            { id: 5, name: 'April Futures Open', date: { day: '17', month: 'Апр' }, location: 'Бишкек, Борбордук корт', time: '09:00 - 17:00', format: 'Жалгыз', participants: '0/24', prize: '10,000 сом', status: 'soon', image: 'https://images.unsplash.com/photo-1551773188-d63e5b03c7ce?w=800&q=80' },
            { id: 6, name: 'Futures Mixed Tournament', date: { day: '01', month: 'Май' }, location: 'Бишкек, Асанбай', time: '10:00 - 18:00', format: 'Аралаш', participants: '0/12 жуп', prize: '8,000 сом', status: 'soon', image: 'https://images.unsplash.com/photo-1530915534664-4ac6423816b7?w=800&q=80' },
            { id: 7, name: 'May Futures Series', date: { day: '15', month: 'Май' }, location: 'Бишкек, Ахунбаева 165', time: '09:00 - 17:00', format: 'Жалгыз', participants: '0/24', prize: '12,000 сом', status: 'soon', image: 'https://images.unsplash.com/photo-1587280501635-68a0e82cd5ff?w=800&q=80' },
            { id: 8, name: 'Summer Futures Championship', date: { day: '05', month: 'Июн' }, location: 'Бишкек, Tennis Park', time: '09:00 - 18:00', format: 'Жалгыз', participants: '0/32', prize: '15,000 сом', status: 'soon', image: 'https://images.unsplash.com/photo-1542144582-1ba00456b5e3?w=800&q=80' },
            { id: 9, name: 'Futures Doubles Open', date: { day: '19', month: 'Июн' }, location: 'Бишкек, Central Court', time: '10:00 - 17:00', format: 'Жуптук', participants: '0/16 жуп', prize: '7,000 сом', status: 'soon', image: 'https://images.unsplash.com/photo-1560012057-4372e14c5085?w=800&q=80' }
        ],
        tour: [
            { id: 1, name: 'KSLT Tour Open #1', date: { day: '15', month: 'Фев' }, location: 'Бишкек, Ахунбаева 165', time: '09:00 - 18:00', format: 'Жалгыз', participants: '24/32', prize: '15,000 сом', status: 'open', image: 'https://images.unsplash.com/photo-1554068865-24cecd4e34b8?w=800&q=80' },
            { id: 2, name: 'KSLT Tour Doubles', date: { day: '22', month: 'Фев' }, location: 'Бишкек, Асанбай 21', time: '10:00 - 17:00', format: 'Жуптук', participants: '12/16 жуп', prize: '20,000 сом', status: 'open', image: 'https://images.unsplash.com/photo-1595435934249-5df7ed86e1c0?w=800&q=80' },
            { id: 3, name: 'Spring Tour Championship', date: { day: '01', month: 'Мар' }, location: 'Бишкек, Борбордук корт', time: '08:00 - 20:00', format: 'Жалгыз', participants: '0/64', prize: '50,000 сом', status: 'soon', image: 'https://images.unsplash.com/photo-1622279457486-62dcc4a431d6?w=800&q=80' },
            { id: 4, name: 'Tour Mixed Cup', date: { day: '15', month: 'Мар' }, location: 'Бишкек, Джал', time: '10:00 - 18:00', format: 'Аралаш', participants: '0/12 жуп', prize: '12,000 сом', status: 'soon', image: 'https://images.unsplash.com/photo-1551773188-d63e5b03c7ce?w=800&q=80' },
            { id: 5, name: 'KSLT Tour Open #2', date: { day: '29', month: 'Мар' }, location: 'Бишкек, Tennis Park', time: '09:00 - 18:00', format: 'Жалгыз', participants: '0/32', prize: '15,000 сом', status: 'soon', image: 'https://images.unsplash.com/photo-1560012057-4372e14c5085?w=800&q=80' },
            { id: 6, name: 'April Tour Doubles', date: { day: '12', month: 'Апр' }, location: 'Бишкек, Асанбай', time: '10:00 - 17:00', format: 'Жуптук', participants: '0/16 жуп', prize: '18,000 сом', status: 'soon', image: 'https://images.unsplash.com/photo-1530915534664-4ac6423816b7?w=800&q=80' },
            { id: 7, name: 'May Tour Championship', date: { day: '10', month: 'Май' }, location: 'Бишкек, Central Court', time: '08:00 - 20:00', format: 'Жалгыз', participants: '0/64', prize: '50,000 сом', status: 'soon', image: 'https://images.unsplash.com/photo-1587280501635-68a0e82cd5ff?w=800&q=80' },
            { id: 8, name: 'Summer Tour Open', date: { day: '07', month: 'Июн' }, location: 'Бишкек, Elite Courts', time: '09:00 - 19:00', format: 'Жалгыз', participants: '0/32', prize: '20,000 сом', status: 'soon', image: 'https://images.unsplash.com/photo-1542144582-1ba00456b5e3?w=800&q=80' },
            { id: 9, name: 'Tour Doubles Grand', date: { day: '21', month: 'Июн' }, location: 'Бишкек, Tennis Palace', time: '10:00 - 18:00', format: 'Жуптук', participants: '0/16 жуп', prize: '25,000 сом', status: 'soon', image: 'https://images.unsplash.com/photo-1560012057-4372e14c5085?w=800&q=80' }
        ],
        friendly: [
            { id: 1, name: 'Weekend Friendly #5', date: { day: '17', month: 'Фев' }, location: 'Бишкек, Асанбай', time: '14:00 - 18:00', format: 'Жалгыз', participants: '12/16', prize: 'Сыйлыксыз', status: 'open', image: 'https://images.unsplash.com/photo-1530915534664-4ac6423816b7?w=800&q=80' },
            { id: 2, name: 'Mixed Doubles Fun', date: { day: '24', month: 'Фев' }, location: 'Бишкек, Джал', time: '15:00 - 19:00', format: 'Аралаш', participants: '6/8 жуп', prize: 'Сыйлыксыз', status: 'open', image: 'https://images.unsplash.com/photo-1554068865-24cecd4e34b8?w=800&q=80' },
            { id: 3, name: 'Family Tennis Day', date: { day: '02', month: 'Мар' }, location: 'Бишкек, Tennis Park', time: '10:00 - 16:00', format: 'Үй-бүлөлүк', participants: '0/20', prize: 'Сыйлыксыз', status: 'soon', image: 'https://images.unsplash.com/photo-1560012057-4372e14c5085?w=800&q=80' },
            { id: 4, name: 'Spring Friendly Cup', date: { day: '09', month: 'Мар' }, location: 'Бишкек, Ахунбаева 165', time: '14:00 - 18:00', format: 'Жалгыз', participants: '0/16', prize: 'Сыйлыксыз', status: 'soon', image: 'https://images.unsplash.com/photo-1595435934249-5df7ed86e1c0?w=800&q=80' },
            { id: 5, name: 'Weekend Friendly #6', date: { day: '16', month: 'Мар' }, location: 'Бишкек, Асанбай', time: '14:00 - 18:00', format: 'Жалгыз', participants: '0/16', prize: 'Сыйлыксыз', status: 'soon', image: 'https://images.unsplash.com/photo-1551773188-d63e5b03c7ce?w=800&q=80' },
            { id: 6, name: 'Doubles Fun Day', date: { day: '23', month: 'Мар' }, location: 'Бишкек, Джал', time: '15:00 - 19:00', format: 'Жуптук', participants: '0/8 жуп', prize: 'Сыйлыксыз', status: 'soon', image: 'https://images.unsplash.com/photo-1622279457486-62dcc4a431d6?w=800&q=80' },
            { id: 7, name: 'April Friendly Open', date: { day: '06', month: 'Апр' }, location: 'Бишкек, Tennis Park', time: '10:00 - 17:00', format: 'Жалгыз', participants: '0/20', prize: 'Сыйлыксыз', status: 'soon', image: 'https://images.unsplash.com/photo-1530915534664-4ac6423816b7?w=800&q=80' },
            { id: 8, name: 'Mixed Fun Tournament', date: { day: '13', month: 'Апр' }, location: 'Бишкек, Central Court', time: '14:00 - 19:00', format: 'Аралаш', participants: '0/8 жуп', prize: 'Сыйлыксыз', status: 'soon', image: 'https://images.unsplash.com/photo-1587280501635-68a0e82cd5ff?w=800&q=80' }
        ]
    },

    // Rankings by gender and category
    rankings: {
        men: {
            promasters: [
        ...
        women: {
            promasters: [
                ...
                { rank: 5, name: 'Жазгүл Өмүрзакова', country: '🇰🇬', tournaments: 5, points: 1870, change: '+3' },
                { rank: 6, name: 'Нургүл Эсенова', country: '🇰🇬', tournaments: 6, points: 1780, change: '-2' },
            ...
            masters: [
                { rank: 1, name: 'Гүлзат Усенова', country: '🇰🇬', tournaments: 7, points: 1650, change: '+2' },
                { rank: 2, name: 'Назгүл Алиева', country: '🇰🇬', tournaments: 8, points: 1580, change: '—' },
                ...
                { rank: 5, name: 'Жыпара Өмүрбекова', country: '🇰🇬', tournaments: 5, points: 1420, change: '—' },
                ...
                { rank: 8, name: 'Асел Мамбетова', country: '🇰🇬', tournaments: 7, points: 1290, change: '—' },
                { rank: 9, name: 'Бермет Касымалиева', country: '🇰🇬', tournaments: 5, points: 1250, change: '+1' },
                { rank: 10, name: 'Айгүл Турдубаева', country: '🇰🇬', tournaments: 6, points: 1200, change: '-1' }
            ],
            challenger: [
                { rank: 1, name: 'Каныкей Сыдыкова', country: '🇰🇬', tournaments: 9, points: 1220, change: '+1' },
                ...
                { rank: 6, name: 'Элмира Токтосунова', country: '🇰🇬', tournaments: 8, points: 1010, change: '+1' },
                { rank: 7, name: 'Нургүл Джолдошева', country: '🇰🇬', tournaments: 10, points: 980, change: '-1' },
                ...
                { rank: 10, name: 'Гүлайым Касымова', country: '🇰🇬', tournaments: 8, points: 870, change: '-2' }
            ],
            futures: [
                { rank: 1, name: 'Айсүлүү Болотова', country: '🇰🇬', tournaments: 12, points: 780, change: '+3' },
                ...
                { rank: 6, name: 'Айчүрөк Эсенова', country: '🇰🇬', tournaments: 12, points: 580, change: '—' },
            ...
            tour: [
                ...
                { rank: 2, name: 'Гүлмира Калыкова', country: '🇰🇬', tournaments: 7, points: 390, change: '+1' },
                { rank: 3, name: 'Нургүл Маматова', country: '🇰🇬', tournaments: 9, points: 360, change: '—' },
                { rank: 4, name: 'Жазгүл Асылбекова', country: '🇰🇬', tournaments: 6, points: 330, change: '-1' },
    ...
    past: {
        ...
        friendly: [
            { name: 'Weekend Friendly #4', date: '02 Фев 2026', winner: 'Баардык катышуучулар!', participants: 16, prize: 'Сыйлыксыз' },
            { name: 'January Fun Tournament', date: '19 Янв 2026', winner: 'Баардык катышуучулар!', participants: 12, prize: 'Сыйлыксыз' }
        ]
    }
};
    ...
    grid.innerHTML = tournaments.map(t => `
        <div class="tournament-card" data-status="${t.status}">
            <div class="tournament-card-header">
                ...
                <span class="tournament-status ${t.status}">${t.status === 'open' ? 'Каттоо ачык' : 'Жакында ачылат'}</span>
            </div>
            <div class="tournament-card-body">
                ...
                <div class="tournament-details">
                    ...
                    <div class="detail-item">
                        <span class="detail-label">Катышуучулар</span>
                        <span class="detail-value">${t.participants}</span>
                    </div>
                    <div class="detail-item">
                        <span class="detail-label">Сыйлык фонду</span>
                        <span class="detail-value prize">${t.prize}</span>
                    </div>
                </div>
            </div>
            <div class="tournament-card-footer">
                <button class="btn-calendar" title="Календарга кошуу">
            ...
            ${index === 4 ? `
                <div class="ranking-blur-overlay">
                    <div class="blur-content">
                        ...
                        <p>Толук рейтингди көрүү үчүн кириңиз</p>
                        <a href="auth-kg.html?redirect=tournaments" class="btn-primary">Кирүү</a>
                    </div>
                </div>
            ` : ''}
        `;
    ...
    grid.innerHTML = past.map((t, index) => `
        <div class="past-tournament-card">
            <div class="past-tournament-header">
                ...
                <span class="past-status completed">Аяктаган</span>
            </div>
            <h4>${t.name}</h4>
            <div class="past-winner">
                <img src="${playerPhotos[index % playerPhotos.length]}" alt="">
                <div class="winner-info">
                    <span class="winner-label">Жеңүүчү</span>
                    <span class="winner-name">${t.winner}</span>
                </div>
                <span class="winner-trophy">🏆</span>
            </div>
            <div class="past-stats">
                <span>${t.participants} катышуучу</span>
                <span>•</span>
                <span>${t.prize}</span>
            </div>
            <a href="tournament-kg.html?id=${category}-past-${index + 1}" class="btn-view-bracket">Торду көрүү</a>
        </div>
    `).join('');
}
...
function initFilters() {
    ...
    filterBtns.forEach(btn => {
        btn.addEventListener('click', function() {
            ...
            if (sectionTitle) {
                if (filter === 'past') {
                    sectionTitle.textContent = 'Аяктаган мелдештер';
                } else {
                    sectionTitle.textContent = 'Алдыдагы мелдештер';
                }
            }
...
function initCalendarButtons() {
    document.addEventListener('click', function(e) {
        ...
        if (regBtn) {
            ...
            if (!isLoggedIn) {
                window.location.href = 'auth-kg.html';
                return;
            }
            ...
            regBtn.textContent = 'Жөнөтүлүүдө...';

            window.KSLT_REG.submit(window.supabaseClient, trnId, { isEn: false, isKg: true })
                .then(function(info) {
    ...
    if (type === 'blocked') {
        overlay.innerHTML =
            '<div class="trn-register-modal">' +
                ...
                '<h3 class="trn-register-modal-title">Мүчөлүк алыңыз</h3>' +
                '<p class="trn-register-modal-text">Мелдештерге каттоо үчүн KSLT мүчөлүгү талап кылынат</p>' +
                '<a href="pricing-kg.html" class="btn-primary trn-register-modal-btn">Мүчөлүк алуу</a>' +
            '</div>';
    } else {
        overlay.innerHTML =
            '<div class="trn-register-modal">' +
                ...
                '<h3 class="trn-register-modal-title">Жакында!</h3>' +
                '<p class="trn-register-modal-text">Мелдештерге онлайн каттоо жакында жеткиликтүү болот</p>' +
            '</div>';
    }
