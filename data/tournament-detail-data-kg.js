// ========================================
// TOURNAMENT DETAIL DATA (KG) - Replace with API later
// ========================================

// Kyrgyz UI labels
window.statusLabels = { completed: 'Аяктаган', live: 'Түз эфир', upcoming: 'Алдыдагы' };
window.heroLabels = { players: 'Оюнчулар', prize: 'Сыйлык фонду', format: 'Формат', elimination: 'Элиминация', roundRobin: 'Тегерек' };
window.rrHeaders = { player: 'Оюнчу', wins: 'Ж', points: 'У', place: 'Орун', playoff: 'Плей-офф' };
window.scheduleLabels = { allDays: 'Бардык күндөр', court: 'Корт' };
window.resultsLabels = { place: 'орун', prize: 'Сыйлык', noResults: 'Жыйынтыктар мелдеш аяктагандан кийин жеткиликтүү болот' };
...
const tournamentDetailData = {
    ...
    "tour-1": {
        ...
        prize: "15,000 сом",
        status: "completed",
        description: "Сезондун биринчи Tour мелдеши. Бардык деңгээлдер үчүн ачык.",
        ...
        schedule: {
            days: [
                {
                    date: "2026-02-15",
                    label: "1-күн — 15 Февраль",
                    matches: [
                        { matchId: "R1-M1", time: "09:00", court: 1, player1Id: 1, player2Id: 16, roundName: "1/8 Финал", status: "completed", score: "6/2 6/1", winnerId: 1 },
                        { matchId: "R1-M2", time: "09:00", court: 2, player1Id: 8, player2Id: 9, roundName: "1/8 Финал", status: "completed", score: "6/4 7/5", winnerId: 8 },
                        { matchId: "R1-M3", time: "09:00", court: 3, player1Id: 4, player2Id: 13, roundName: "1/8 Финал", status: "completed", score: "6/3 6/4", winnerId: 4 },
                        { matchId: "R1-M4", time: "10:30", court: 1, player1Id: 5, player2Id: 12, roundName: "1/8 Финал", status: "completed", score: "6/1 6/3", winnerId: 5 },
                        { matchId: "R1-M5", time: "10:30", court: 2, player1Id: 3, player2Id: 14, roundName: "1/8 Финал", status: "completed", score: "6/0 6/2", winnerId: 3 },
                        { matchId: "R1-M6", time: "10:30", court: 3, player1Id: 6, player2Id: 11, roundName: "1/8 Финал", status: "completed", score: "3/6 6/4 6/3", winnerId: 6 },
                        { matchId: "R1-M7", time: "12:00", court: 1, player1Id: 7, player2Id: 10, roundName: "1/8 Финал", status: "completed", score: "6/4 6/7 7/5", winnerId: 10 },
                        { matchId: "R1-M8", time: "12:00", court: 2, player1Id: 2, player2Id: 15, roundName: "1/8 Финал", status: "completed", score: "6/1 6/0", winnerId: 2 },
                        { matchId: "QF-M1", time: "14:00", court: 1, player1Id: 1, player2Id: 8, roundName: "Чейрек финал", status: "completed", score: "6/3 6/2", winnerId: 1 },
                        { matchId: "QF-M2", time: "14:00", court: 2, player1Id: 4, player2Id: 5, roundName: "Чейрек финал", status: "completed", score: "4/6 6/3 7/6", winnerId: 5 },
                        { matchId: "QF-M3", time: "14:00", court: 3, player1Id: 3, player2Id: 6, roundName: "Чейрек финал", status: "completed", score: "6/4 6/3", winnerId: 3 },
                        { matchId: "QF-M4", time: "16:00", court: 1, player1Id: 10, player2Id: 2, roundName: "Чейрек финал", status: "completed", score: "3/6 2/6", winnerId: 2 }
                    ]
                },
                {
                    date: "2026-02-16",
                    label: "2-күн — 16 Февраль",
                    matches: [
                        { matchId: "SF-M1", time: "10:00", court: 1, player1Id: 1, player2Id: 5, roundName: "Жарым финал", status: "completed", score: "6/4 3/6 6/2", winnerId: 1 },
                        { matchId: "SF-M2", time: "10:00", court: 2, player1Id: 3, player2Id: 2, roundName: "Жарым финал", status: "completed", score: "6/7 6/4 7/5", winnerId: 2 },
    ...
    "friendly-1": {
        ...
        date: "17 Февраль 2026",
        dateRange: "17 Февраль 2026",
        ...
        prize: "Сыйлыксыз",
        status: "completed",
        description: "Рейтинг упайларысыз достук мелдеш. Ырахат алып ойноңуз!",
            ...
            days: [
                {
                    ...
                    label: "17 Февраль",
                    matches: [
                        { matchId: "GA-M1", time: "14:00", court: 1, player1Id: 1, player2Id: 2, roundName: "А тобу", status: "completed", score: "0/6 3/6", winnerId: 2 },
                        { matchId: "GA-M2", time: "14:00", court: 2, player1Id: 1, player2Id: 3, roundName: "А тобу", status: "completed", score: "1/6 1/6", winnerId: 3 },
                        { matchId: "GB-M1", time: "14:00", court: 1, player1Id: 5, player2Id: 6, roundName: "Б тобу", status: "completed", score: "6/4 6/3", winnerId: 5 },
                        { matchId: "GA-M3", time: "14:45", court: 1, player1Id: 1, player2Id: 4, roundName: "А тобу", status: "completed", score: "6/3 6/4", winnerId: 1 },
                        { matchId: "GA-M4", time: "14:45", court: 2, player1Id: 2, player2Id: 3, roundName: "А тобу", status: "completed", score: "6/1 6/0", winnerId: 2 },
                        { matchId: "GB-M2", time: "14:45", court: 2, player1Id: 5, player2Id: 7, roundName: "Б тобу", status: "completed", score: "3/6 6/4 6/2", winnerId: 5 },
                        { matchId: "GA-M5", time: "15:30", court: 1, player1Id: 2, player2Id: 4, roundName: "А тобу", status: "completed", score: "6/2 6/1", winnerId: 2 },
                        { matchId: "GA-M6", time: "15:30", court: 2, player1Id: 3, player2Id: 4, roundName: "А тобу", status: "completed", score: "6/3 6/2", winnerId: 3 },
                        { matchId: "GB-M3", time: "15:30", court: 1, player1Id: 5, player2Id: 8, roundName: "Б тобу", status: "completed", score: "6/7 4/6", winnerId: 8 },
                        { matchId: "GB-M4", time: "14:00", court: 2, player1Id: 6, player2Id: 7, roundName: "Б тобу", status: "completed", score: "6/3 6/4", winnerId: 6 },
                        { matchId: "GB-M5", time: "14:45", court: 1, player1Id: 6, player2Id: 8, roundName: "Б тобу", status: "completed", score: "4/6 3/6", winnerId: 8 },
                        { matchId: "GB-M6", time: "15:30", court: 2, player1Id: 7, player2Id: 8, roundName: "Б тобу", status: "completed", score: "6/4 3/6 6/7", winnerId: 8 },
                        { matchId: "KO-F", time: "16:30", court: 1, player1Id: 2, player2Id: 8, roundName: "1-орун үчүн", status: "completed", score: "6/3 7/5", winnerId: 2 },
                        { matchId: "KO-3", time: "16:30", court: 2, player1Id: 3, player2Id: 5, roundName: "3-орун үчүн", status: "completed", score: "6/4 6/4", winnerId: 3 }
                    ]
                }
            ]
        },
    ...
    "masters-1": {
        ...
        prize: "40,000 сом",
        status: "live",
        description: "2026 Masters серия боюнча биринчи мелдеш.",
        ...
        schedule: {
            days: [
                {
                    date: "2026-02-14",
                    label: "1-күн — 14 Февраль",
                    matches: [
                        { matchId: "R1-M1", time: "09:00", court: 1, player1Id: 1, player2Id: 16, roundName: "1/8 Финал", status: "completed", score: "6/1 6/2", winnerId: 1 },
                        { matchId: "R1-M2", time: "09:00", court: 2, player1Id: 8, player2Id: 9, roundName: "1/8 Финал", status: "completed", score: "6/3 6/4", winnerId: 8 },
                        { matchId: "R1-M3", time: "09:00", court: 3, player1Id: 4, player2Id: 13, roundName: "1/8 Финал", status: "completed", score: "6/2 6/3", winnerId: 4 },
                        { matchId: "R1-M4", time: "09:00", court: 4, player1Id: 5, player2Id: 12, roundName: "1/8 Финал", status: "completed", score: "7/5 6/4", winnerId: 5 },
                        { matchId: "R1-M5", time: "11:00", court: 1, player1Id: 3, player2Id: 14, roundName: "1/8 Финал", status: "completed", score: "6/1 6/3", winnerId: 3 },
                        { matchId: "R1-M6", time: "11:00", court: 2, player1Id: 6, player2Id: 11, roundName: "1/8 Финал", status: "completed", score: "6/4 6/2", winnerId: 6 },
                        { matchId: "R1-M7", time: "11:00", court: 3, player1Id: 7, player2Id: 10, roundName: "1/8 Финал", status: "completed", score: "6/3 3/6 7/5", winnerId: 7 },
                        { matchId: "R1-M8", time: "11:00", court: 4, player1Id: 2, player2Id: 15, roundName: "1/8 Финал", status: "completed", score: "6/0 6/2", winnerId: 2 },
                        { matchId: "QF-M1", time: "14:00", court: 1, player1Id: 1, player2Id: 8, roundName: "Чейрек финал", status: "completed", score: "6/4 6/3", winnerId: 1 },
                        { matchId: "QF-M2", time: "14:00", court: 2, player1Id: 4, player2Id: 5, roundName: "Чейрек финал", status: "completed", score: "3/6 6/2 6/4", winnerId: 4 },
                        { matchId: "QF-M3", time: "16:00", court: 1, player1Id: 3, player2Id: 6, roundName: "Чейрек финал", status: "live", score: "5/4", winnerId: null },
                        { matchId: "QF-M4", time: "16:00", court: 2, player1Id: 7, player2Id: 2, roundName: "Чейрек финал", status: "upcoming", score: "", winnerId: null }
                    ]
                },
                {
                    date: "2026-02-15",
                    label: "2-күн — 15 Февраль",
                    matches: [
                        { matchId: "SF-M1", time: "10:00", court: 1, player1Id: 1, player2Id: 4, roundName: "Жарым финал", status: "upcoming", score: "", winnerId: null },
                        { matchId: "SF-M2", time: "10:00", court: 2, player1Id: null, player2Id: null, roundName: "Жарым финал", status: "upcoming", score: "", winnerId: null },
...
tournamentDetailData["promasters-1"] = generateTournament({
    ...
    date: "8 Март 2026",
    dateRange: "8–10 Март 2026",
    location: "Бишкек, Central Court",
    time: "09:00 – 19:00",
    bracketType: "single_elimination",
    prize: "100,000 сом",
    status: "upcoming",
    description: "Сезондун башкы мелдеши. 32 мыкты оюнчу.",
    bgImage: "https://images.unsplash.com/photo-1551773188-d63e5b03c7ce?w=1920&q=80",
    courtCount: 4,
    startTime: "09:00",
    matchDuration: 90,
    days: [
        { date: "2026-03-08", label: "1-күн — 8 Март" },
        { date: "2026-03-09", label: "2-күн — 9 Март" },
        { date: "2026-03-10", label: "3-күн — 10 Март" }
    ],
    players: [
