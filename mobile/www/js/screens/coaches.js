...
(function() {
  ...
  function render() {
    ...
    for (var i = 0; i < visibleCount; i++) {
      ...
      if (c.partner) html += '<span class="coach-partner-badge">' + I18N.t('coaches.partner') + '</span>';
      html += '</div>';
      ...
      if (c.experience) html += '<span>🎯 ' + c.experience + ' ' + I18N.t('coaches.years') + '</span>';
      if (c.price) html += '<span>💰 ' + c.price + ' ' + I18N.t('coaches.perHour') + '</span>';
      html += '</div>';
      if (c.tags.length > 0) {
