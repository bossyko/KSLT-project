...
(function() {
  ...
  function render() {
    ...
    if (displayPlayers.length === 0) {
      el.innerHTML = '<div class="empty-state"><div class="empty-icon">📊</div><div class="empty-title">' + I18N.t('rating.empty') + '</div><div class="empty-text">' + (currentSearch ? 'По запросу «' + esc(currentSearch) + '» ничего не найдено' : I18N.t('rating.emptyText')) + '</div></div>';
      return;
    }
    ...
    html += '<div class="rating-table-head">' +
      ...
      '<span class="rt-col-form">' + I18N.t('rating.form') + '</span>' +
    '</div>';
