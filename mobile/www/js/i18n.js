...
(function() {
  ...
  var T = {
    ...
    'ach.kicker':       { ru: 'Новое достижение', en: 'New achievement', kg: 'Жаңы жетишкендик' },
    'ach.next':         { ru: 'Дальше',           en: 'Next',            kg: 'Кийинки' },
    'ach.done':         { ru: 'Отлично',          en: 'Great',           kg: 'Сонун' },
    'ach.left':         { ru: 'осталось ещё ',    en: 'more to go: ',    kg: 'дагы калды: ' },
    'menu.about':       { ru: 'О проекте',    en: 'About the Project', kg: 'Долбоор жөнүндө' },
    ...
    'home.badgesShort': { ru: 'Достижения', en: 'Achievements', kg: 'Жетишкендиктер' },
    ...
    'pd.doubles':    { ru: 'Парный',      en: 'Doubles',       kg: 'Жуптук' },
    'pd.mixed':      { ru: 'Микст',       en: 'Mixed',         kg: 'Микст' },
    'pd.winsLosses': { ru: 'побед / поражений', en: 'wins / losses', kg: 'жеңиш / жеңилүү' },
    'coach.priceMember': { ru: 'членам КСЛТ', en: 'KSLT members', kg: 'KSLT мүчөлөрүнө' },
    'coach.students':    { ru: 'учеников',     en: 'students',     kg: 'окуучу' },
    'court.schedule': { ru: 'Часы работы', en: 'Opening hours', kg: 'Иш убактысы' },
    'court.services': { ru: 'Дополнительно', en: 'Additional services', kg: 'Кошумча кызматтар' },
    'profile.myBattles':     { ru: 'Мои баттлы',  en: 'My battles',  kg: 'Менин баттлдарым' },
    'profile.noBattles':     { ru: 'Баттлов пока нет', en: 'No battles yet', kg: 'Баттлдар жок' },
    'profile.noBattlesText': { ru: 'Вызовите игрока на матч из его карточки',
                               en: 'Challenge a player from their profile',
                               kg: 'Оюнчунун картасынан аны матчка чакырыңыз' },
    'profile.chalActive':      { ru: 'Активен',       en: 'Active',       kg: 'Активдүү' },
    'profile.chalNegotiating': { ru: 'Обсуждается',   en: 'Negotiating',  kg: 'Талкууланууда' },
    'profile.chalCountered':   { ru: 'Встречное',     en: 'Countered',    kg: 'Каршы сунуш' },
    'profile.chalAccepted':    { ru: 'Принят',        en: 'Accepted',     kg: 'Кабыл алынды' },
    'profile.chalDeclined':    { ru: 'Отклонён',      en: 'Declined',     kg: 'Четке кагылды' },
    'profile.chalExpired':     { ru: 'Истёк',         en: 'Expired',      kg: 'Мөөнөтү бүттү' },
    'profile.chalCompleted':   { ru: 'Сыгран',        en: 'Completed',    kg: 'Ойнолду' },
    'profile.chalCancelled':   { ru: 'Отменён',       en: 'Cancelled',    kg: 'Жокко чыгарылды' },
    'td.fee':       { ru: 'Взнос',        en: 'Entry fee',   kg: 'Катышуу акысы' },
    'td.feeMember': { ru: 'членам',       en: 'members',     kg: 'мүчөлөргө' },
    'td.feeGuest':  { ru: 'гостям',       en: 'guests',      kg: 'конокторго' },
    'td.venue':     { ru: 'Место',        en: 'Venue',       kg: 'Орду' },
    ...
    'home.stMembers':     { ru: 'Членов клуба',      en: 'Club members',   kg: 'Клуб мүчөлөрү' },
    // Короче, чем «Зарегистрировано»: то слово вдвое длиннее остальных
    'home.stUsers':       { ru: 'Аккаунтов',       en: 'Accounts',      kg: 'Аккаунттар' },
    'home.stTournaments': { ru: 'Турниров',         en: 'Tournaments',    kg: 'Мелдештер' },
    'home.stCourts':      { ru: 'Теннисных центров', en: 'Tennis centres', kg: 'Теннис борборлору' },
    'home.stCoaches':     { ru: 'Тренеров',         en: 'Coaches',        kg: 'Машыктыруучулар' },
    'home.sponsorTitle': { ru: 'Спонсор КСЛТ', en: 'KSLT Sponsor', kg: 'KSLT демөөрчүсү' },
    'home.sponsorSite':  { ru: 'Перейти на сайт', en: 'Open website', kg: 'Сайтка өтүү' },
    ...
    'td.needMembership':{ ru: 'Для участия нужно членство КСЛТ', en: 'KSLT membership required to participate', kg: 'Катышуу үчүн KSLT мүчөлүгү керек' },
    ...
    'trn.needMembership': { ru: 'Для участия необходимо членство КСЛТ', en: 'KSLT membership required to participate', kg: 'Катышуу үчүн KSLT мүчөлүгү керек' },
    ...
    'reg.errNoMember':    { ru: 'Требуется активное членство КСЛТ', en: 'Active KSLT membership required', kg: 'KSLT активдүү мүчөлүгү талап кылынат' },
    ...
    'rating.notMember':  { ru: 'не член клуба',       en: 'not a member',    kg: 'мүчө эмес' },
    'coaches.emptySoon': { ru: 'Список тренеров скоро появится',
                           en: 'The list of coaches will appear soon',
                           kg: 'Машыктыруучулардын тизмеси жакында пайда болот' },
    'partners.fAll':   { ru: 'Все',      en: 'All',    kg: 'Баары' },
    'partners.fMen':   { ru: 'Мужчины',  en: 'Men',    kg: 'Эркектер' },
    'partners.fWomen': { ru: 'Женщины',  en: 'Women',  kg: 'Аялдар' },
    'partners.lvlAll': { ru: 'Все уровни', en: 'All levels', kg: 'Бардык деңгээлдер' },
    'partners.lvl1':   { ru: 'Начинающий', en: 'Beginner',     kg: 'Башталгыч' },
    'partners.lvl2':   { ru: 'Средний',    en: 'Intermediate', kg: 'Орточо' },
    'partners.lvl3':   { ru: 'Продвинутый', en: 'Advanced',    kg: 'Өнүккөн' },
    'partners.lvl4':   { ru: 'Сильный',    en: 'Strong',       kg: 'Күчтүү' },
    'rating.showMore':   { ru: 'Показать ещё',        en: 'Show more',       kg: 'Дагы көрсөтүү' },
    ...
    'news.subtitle':    { ru: 'Последние события КСЛТ', en: 'Latest KSLT events', kg: 'KSLT акыркы окуялар' },
    ...
    // Метки рода матча. В историю идёт всё сыгранное, в зачёт — только
    // рейтинговые одиночные; метка объясняет расхождение прямо у строки
    'match.tagRating':      { ru: 'рейтинг',              en: 'rating',            kg: 'рейтинг' },
    'match.tagFriendly':    { ru: 'дружеский',            en: 'friendly',          kg: 'достук' },
    'match.tagDoubles':     { ru: 'пары',                 en: 'doubles',           kg: 'жуптук' },
    'match.tagMixed':       { ru: 'микст',                en: 'mixed',             kg: 'аралаш' },
    'match.tagBattle':      { ru: 'баттл',                en: 'battle',            kg: 'баттл' },
    'battle.doubles':       { ru: 'пары',                 en: 'doubles',           kg: 'жуптук' },
    'battle.menDoubles':    { ru: 'мужские пары',         en: "men's doubles",     kg: 'эркектер жуптугу' },
    'battle.womenDoubles':  { ru: 'женские пары',         en: "women's doubles",   kg: 'аялдар жуптугу' },
    'battle.mixed':         { ru: 'микст',                en: 'mixed',             kg: 'аралаш' },
    'pairs.record':         { ru: 'В парах',              en: 'In doubles',        kg: 'Жуптукта' },
    'pairs.title':          { ru: 'Парные',               en: 'Doubles',           kg: 'Жуптук' },
    'pairs.mixed':          { ru: 'Микст',                en: 'Mixed',             kg: 'Аралаш' },
    'pairs.note':           { ru: 'в рейтинг не идут',    en: 'not in rating',     kg: 'рейтингге кирбейт' },
    'pairs.matches':        { ru: 'Матчей',               en: 'Matches',           kg: 'Матчтар' },
    'pairs.winRate':        { ru: 'побед',                en: 'wins',              kg: 'жеңиш' },
    'match.statsNote':      { ru: 'Статистика по рейтинговым одиночным турнирам',
                              en: 'Statistics from rating singles tournaments only',
                              kg: 'Статистика рейтингдик жеке мелдештер боюнча' },
    ...
    'coaches.subtitle':    { ru: 'Профессиональные тренеры КСЛТ', en: 'Professional KSLT coaches', kg: 'KSLT профессионал машыктыруучулар' },
    ...
    'coach.contactsLocked':{ ru: 'Контакты тренера доступны для членов КСЛТ', en: 'Coach contacts available for KSLT members', kg: 'Тренер байланыштары KSLT мүчөлөрү үчүн жеткиликтүү' },
    ...
    'court.contactLocked': { ru: 'Контакты корта доступны для членов КСЛТ', en: 'Court contacts available for KSLT members', kg: 'Корт байланыштары KSLT мүчөлөрү үчүн жеткиликтүү' },
    ...
    'pd.memberCta':      { ru: 'Для вызовов нужно членство КСЛТ', en: 'KSLT membership required for challenges', kg: 'Чакыруулар үчүн KSLT мүчөлүгү керек' },
    ...
    'onb.step1.text':    { ru: 'КСЛТ — теннисное сообщество Кыргызстана. Рейтинги, турниры и баттлы в одном приложении.', en: 'KSLT — tennis community of Kyrgyzstan. Rankings, tournaments and battles in one app.', kg: 'KSLT — Кыргызстандын теннис коому. Рейтингдер, мелдештер жана баттлдар бир тиркемеде.' },
    ...
    'onb.step3.text':    { ru: 'Члены КСЛТ получают полный доступ: турниры, вызовы, скидки и баллы лояльности.', en: 'KSLT members get full access: tournaments, challenges, discounts and loyalty points.', kg: 'KSLT мүчөлөрү толук мүмкүнчүлүк алышат: мелдештер, чакыруулар, арзандатуулар жана лоялдуулук упайлары.' },
    ...
    'score.alreadyDone': { ru: 'Счёт уже подтверждён', en: 'The score is already confirmed', kg: 'Эсеп мурун ырасталган' },
    'score.alreadySent': { ru: 'Счёт уже вписан — ждём соперника', en: 'The score is already entered', kg: 'Эсеп жазылган — каршылашты күтөбүз' },
    'score.youWon':    { ru: 'Вы выиграли',      en: 'You won',           kg: 'Сиз жеңдиңиз' },
    'score.youLost':   { ru: 'Вы проиграли',    en: 'You lost',          kg: 'Сиз жеңилдиңиз' },
    'score.todo':      { ru: 'Ждёт вашего ответа', en: 'Needs your answer', kg: 'Жооп күтөт' },
    'score.enter':     { ru: 'Вписать счёт',      en: 'Enter score',       kg: 'Эсепти жазуу' },
    'score.confirm':   { ru: 'Подтвердить',       en: 'Confirm',           kg: 'Ырастоо' },
    'score.dispute':   { ru: 'Не согласен',       en: 'Not correct',       kg: 'Туура эмес' },
    'score.entered':   { ru: 'вписал счёт',       en: 'entered the score', kg: 'эсепти жазды' },
    'score.waiting':   { ru: 'ждём соперника',    en: 'waiting for opponent', kg: 'каршылашты күтөбүз' },
    'score.battle':    { ru: 'Баттл',             en: 'Battle',            kg: 'Баттл' },
    'score.title':     { ru: 'Счёт матча',        en: 'Match score',       kg: 'Оюндун эсеби' },
    'score.titleConfirm': { ru: 'Подтвердите счёт', en: 'Confirm the score', kg: 'Эсепти ырастаңыз' },
    'score.date':      { ru: 'Дата матча',        en: 'Match date',        kg: 'Оюндун күнү' },
    'score.player':    { ru: 'Игрок',             en: 'Player',            kg: 'Оюнчу' },
    'score.set':       { ru: 'Сет',               en: 'Set',               kg: 'Сет' },
    'score.hint':      { ru: 'Впишите геймы в каждом сете. Победителя считаем из счёта.', en: 'Enter games won in each set. The winner is worked out from the score.', kg: 'Ар бир сетте алынган геймдерди жазыңыз. Жеңүүчү эсептен чыгарылат.' },
    'score.send':      { ru: 'Отправить счёт',    en: 'Submit score',      kg: 'Эсепти жөнөтүү' },
    'score.auto':      { ru: 'Не ответите в течение суток — счёт примется как есть.', en: 'If you do not answer within a day, the score is accepted as is.', kg: 'Бир күндүн ичинде жооп болбосо, эсеп ушул бойдон кабыл алынат.' },
    'score.sent':      { ru: 'Счёт отправлен — ждём соперника', en: 'Score sent — waiting for your opponent', kg: 'Эсеп жөнөтүлдү — каршылашты күтөбүз' },
    'score.confirmed': { ru: 'Счёт подтверждён',  en: 'Score confirmed',   kg: 'Эсеп ырасталды' },
    'score.disputed':  { ru: 'Матч ушёл организатору', en: 'Sent to the organiser', kg: 'Уюштуруучуга жөнөтүлдү' },
    'score.errBad':    { ru: 'Проверьте счёт: геймы в сете не могут быть равны', en: 'Check the score: games in a set cannot be equal', kg: 'Эсепти текшериңиз: сеттеги геймдер бирдей болбойт' },
    'score.errOwn':    { ru: 'Свой счёт подтверждает соперник', en: 'Your own score is confirmed by the opponent', kg: 'Өз эсебиңизди каршылаш ырастайт' },
    'score.errFinal':  { ru: 'Счёт уже окончательный', en: 'The score is already final', kg: 'Эсеп мурун бекитилген' },
    'score.errNotPlayer': { ru: 'Вы не играете в этом матче', en: 'You are not playing in this match', kg: 'Сиз бул оюнда ойнобойсуз' },
    'score.errNoWinner': { ru: 'По сетам никто не выиграл', en: 'Nobody won by sets', kg: 'Сеттер боюнча жеңүүчү жок' },
    'score.err':       { ru: 'Не удалось сохранить счёт', en: 'Could not save the score', kg: 'Эсеп сакталган жок' },
    ...
    'profile.tgDisconnect': { ru: 'Отключить бота', en: 'Disconnect the bot', kg: 'Ботту ажыратуу' },
    'profile.tgWaiting':    { ru: 'Ждём подключения…', en: 'Waiting for the connection…', kg: 'Байланууну күтүүдө…' },
    'profile.tgConnectedNow': { ru: 'Подключено!', en: 'Connected!', kg: 'Байланды!' },
    ...
    'restore.title':          { ru: 'Аккаунт помечен на удаление', en: 'Account scheduled for deletion', kg: 'Аккаунт өчүрүүгө белгиленген' },
    'restore.text':           { ru: 'Вы просили удалить учётную запись. Она будет удалена насовсем {date} — до этого дня всё можно вернуть.', en: 'You asked to delete your account. It will be erased for good on {date} — until then everything can be restored.', kg: 'Сиз аккаунтуңузду өчүрүүнү сурадыңыз. Ал {date} биротоло өчүрүлөт — ага чейин баарын кайтарууга болот.' },
    'restore.keep':           { ru: 'Оставить аккаунт', en: 'Keep my account', kg: 'Аккаунтту калтыруу' },
    'restore.leave':          { ru: 'Всё равно удалить', en: 'Delete anyway', kg: 'Баары бир өчүрүү' },
    'restore.done':           { ru: 'Аккаунт восстановлен', en: 'Account restored', kg: 'Аккаунт калыбына келтирилди' },
    ...
    // Слово в слово с сайтом (js/partners.js, js/dashboard.js): разошедшиеся
    // тексты — самая частая причина «а почему в приложении по-другому»
    'inv.title':         { ru: 'Приглашения',        en: 'Invitations',        kg: 'Чакыруулар' },
    'inv.btn':           { ru: 'Предложить игру',    en: 'Invite to play',     kg: 'Оюн сунуштоо' },
    'inv.confirmTitle':  { ru: 'Отправить приглашение на игру?', en: 'Send game invitation?', kg: 'Оюнга чакыруу жөнөтөсүзбү?' },
    'inv.confirmText':   { ru: 'Если игрок примет приглашение, вы обменяетесь контактами: он увидит ваши, вы — его.',
                           en: 'If the player accepts, you will exchange contacts: they will see yours, you will see theirs.',
                           kg: 'Оюнчу кабыл алса, байланыш маалыматтарыңыз менен алмашасыз: ал сиздикин, сиз анын маалыматын көрөсүз.' },
    'inv.confirmBtn':    { ru: 'Отправить',          en: 'Send',               kg: 'Жөнөтүү' },
    'inv.cancel':        { ru: 'Отмена',             en: 'Cancel',             kg: 'Жокко чыгаруу' },
    'inv.close':         { ru: 'Закрыть',            en: 'Close',              kg: 'Жабуу' },
    'inv.sent':          { ru: 'Приглашение отправлено!', en: 'Invitation sent!', kg: 'Чакыруу жөнөтүлдү!' },
    'inv.error':         { ru: 'Не удалось отправить приглашение', en: 'Failed to send invitation', kg: 'Чакыруу жөнөтүлгөн жок' },
    'inv.limit':         { ru: 'Лимит приглашений на сегодня (5/день)', en: 'Daily invite limit reached (5/day)', kg: 'Күнүмдүк чакыруу лимити (5/күн)' },
    'inv.pending':       { ru: 'Приглашение уже отправлено', en: 'Invitation already sent', kg: 'Чакыруу мурунтан жөнөтүлгөн' },
    'inv.noAccount':     { ru: 'Игрок ещё не зарегистрирован на платформе', en: 'This player is not on the platform yet', kg: 'Бул оюнчу платформада катталган эмес' },
    'inv.noContactsSend':{ ru: 'Игрок не указал контактов — обменяться будет нечем', en: 'This player has not provided any contacts', kg: 'Бул оюнчу байланыш маалыматын көрсөткөн эмес' },
    'inv.self':          { ru: 'Нельзя пригласить себя', en: 'Cannot invite yourself', kg: 'Өзүңдү чакыра албайсыз' },
    'inv.notMember':     { ru: 'Приглашения доступны членам КСЛТ', en: 'Invitations are for KSLT members', kg: 'Чакыруулар КСЛТ мүчөлөрүнө жеткиликтүү' },
    'inv.accept':        { ru: 'Принять',            en: 'Accept',             kg: 'Кабыл алуу' },
    'inv.decline':       { ru: 'Отклонить',          en: 'Decline',            kg: 'Четке кагуу' },
    'inv.shareWarn':     { ru: 'После согласия вы обменяетесь контактами: соперник увидит ваши, вы — его.',
                           en: 'Once you accept, you will exchange contacts: they will see yours, you will see theirs.',
                           kg: 'Кабыл алгандан кийин байланыш маалыматтарыңыз менен алмашасыз: ал сиздикин, сиз анын маалыматын көрөсүз.' },
    'inv.showContacts':  { ru: 'Показать контакты',  en: 'Show contacts',      kg: 'Байланыштарды көрсөтүү' },
    'inv.contactsTitle': { ru: 'Контакты',           en: 'Contacts',           kg: 'Байланыштар' },
    'inv.noContacts':    { ru: 'Контакты не указаны', en: 'No contacts provided', kg: 'Байланыш маалыматы жок' },
    'inv.accepted':      { ru: 'Принято',            en: 'Accepted',           kg: 'Кабыл алынды' },
    'inv.declined':      { ru: 'Отклонено',          en: 'Declined',           kg: 'Четке кагылды' },
    'inv.pendingLabel':  { ru: 'Ожидает',            en: 'Pending',            kg: 'Күтүүдө' },
    'inv.sentLabel':     { ru: 'Отправлено вами',    en: 'Sent by you',        kg: 'Сиз жөнөттүңүз' },
    'inv.receivedLabel': { ru: 'Получено',           en: 'Received',           kg: 'Келди' },
    'inv.emptyTitle':    { ru: 'Приглашений пока нет', en: 'No invitations yet', kg: 'Чакыруулар жок' },
    'inv.emptyText':     { ru: 'Откройте карточку игрока и предложите игру',
                           en: 'Open a player card and invite them to play',
                           kg: 'Оюнчунун картасын ачып, оюн сунуштаңыз' },

    // === Pricing ===
    'pricing.title':             { ru: 'Членство КСЛТ',          en: 'KSLT Membership',       kg: 'KSLT мүчөлүгү' },
    ...
    'pricing.feat1':             { ru: 'Участие во всех турнирах КСЛТ', en: 'Participate in all KSLT tournaments', kg: 'Бардык KSLT мелдештерине катышуу' },
    ...
    'td.gamesShort':   { ru: 'Геймы',            en: 'Games',         kg: 'Геймдер' },
    'td.posShort':     { ru: 'М',                en: 'Pos',           kg: 'О' },
    'td.whyHead':      { ru: 'личная встреча',   en: 'head-to-head',  kg: 'өз ара беттеш' },
    'td.whyMini':      { ru: 'между собой',      en: 'among tied',    kg: 'өз ара' },
    'td.whySets':      { ru: 'по сетам',         en: 'on sets',       kg: 'сеттер боюнча' },
    'td.whyGames':     { ru: 'по геймам',        en: 'on games',      kg: 'геймдер боюнча' },
    'td.lot':          { ru: 'жребий',           en: 'by lot',        kg: 'чүчүкулак' },
    'td.lotHint':      { ru: 'Победы, сеты и геймы равны — место определено жребием',
                         en: 'Wins, sets and games are all equal — the place is decided by lot',
                         kg: 'Жеңиштер, сеттер жана геймдер бирдей — орун чүчүкулак менен аныкталган' },
