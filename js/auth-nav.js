        ...
        if (session && session.access_token && session.expires_at) {
            ...
            if (session.expires_at > now) {
                ...
                if (isStaff) {
                    ...
                    // Add divider + profile + logout
                    menuItems += '<div style="height:1px;background:var(--border-subtle);margin:6px 0;"></div>';
                    menuItems += '<a href="' + dashUrl + '#profile" class="nav-dropdown-item">' +
                        '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" width="14" height="14" style="opacity:0.6;"><path d="M20 21v-2a4 4 0 00-4-4H8a4 4 0 00-4 4v2"/><circle cx="12" cy="7" r="4"/></svg> ' +
                        L.profile + '</a>';
                    menuItems += '<a href="' + dashUrl + '#settings" class="nav-dropdown-item">' +
                        '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" width="14" height="14" style="opacity:0.6;"><circle cx="12" cy="12" r="3"/><path d="M12 1v2m0 18v2M4.22 4.22l1.42 1.42m12.72 12.72l1.42 1.42M1 12h2m18 0h2M4.22 19.78l1.42-1.42M18.36 5.64l1.42-1.42"/></svg> ' +
                        L.settings + '</a>';
