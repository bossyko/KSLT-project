...
(function () {
     ...
     *
     * Один вид у всех больших карточек, включая завершённые: иначе на
     * странице рядом стоят две разные большие карточки, и кажется, будто
     * что-то сломалось.
     */
    function боком(t) {
