...
(function() {
    ...
    var ROLE_SECTIONS = {
        admin:   ['dashboard', 'content', 'tournaments', 'players', 'courts', 'coaches', 'users', 'finances', 'vouchers', 'loyalty', 'settings'],
        manager: ['dashboard', 'content', 'tournaments', 'players', 'courts', 'coaches', 'users', 'finances', 'vouchers', 'loyalty']
    };
