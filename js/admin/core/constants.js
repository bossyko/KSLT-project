...
(function() {
    ...
    var L = isEn ? {
        ...
        schedStLive: 'Live',
        schedStDone: 'Done',
        schedCallReady: 'Get ready',
        schedCallGo: 'To the court',
        ...
        regFrozen: 'The draw is made — the line-up is locked. To change it, regenerate the draw on the Group tab.',
        ...
        regFrozen: 'Сетка сформирована — состав закрыт. Чтобы изменить его, пересоздай жеребьёвку во вкладке «Группа».',
