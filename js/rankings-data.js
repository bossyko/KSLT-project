...
(function() {
    ...
    async function load() {
        ...
        try {
            ...
            // Сколько в клубе игроков — счётчик для шапки. Считаем по карточкам,
            // а не по спискам разрядов: там один человек стоит в нескольких
            // категориях, и в шапке выходило больше людей, чем есть на самом
            // деле. Те, кто зарегистрировался и ещё не играл, тоже игроки —
            // они в разряды не попадают, но в клубе уже есть
            window.KSLT_RANKINGS.всегоИгроков = players.length;
    ...
    window.KSLT_RANKINGS = { load: load, всегоИгроков: null };
