...
(function() {
    ...
    // Значки лежат в js/contact-icons.js — там же их берут карточка игрока
    // и колокольчик. Раньше здесь стояла своя копия, и разметка расходилась
    var CONTACT_ICON = window.KSLT_CONTACT_ICONS || {};
