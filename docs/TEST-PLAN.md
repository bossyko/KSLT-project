...
| # | Тест-кейс | Шаги | Ожидание |
|---|-----------|------|----------|
| 12.1 | Battle cards на главной | Главная → секция "Баттлы" | Карточки в 3 колонки (desktop), данные из Supabase |
| 12.2 | Battle cards на турнирах | Tournaments overview → секция "Баттлы" | Карточки с VS, дата, голосование |
| 12.3 | Battle cards: responsive | Viewport 480px | 1 колонка; 768px → 2 колонки |
| 12.4 | Battle card: клик "Подробнее" | Клик на ссылку карточки | Переход на challenge.html?id=X |
| 12.5 | Challenge page: VS layout | GET /pages/challenge.html?id=X | Фото игроков, имена, статистика, VS |
| 12.6 | Challenge page: breadcrumb | Перейти с главной → challenge | Sticky breadcrumb "← Главная / Баттлы" |
| 12.7 | Challenge page: breadcrumb из турниров | Перейти с tournaments-overview → challenge | Sticky breadcrumb "← Турниры / Баттлы" |
| 12.8 | Голосование: авторизованный | Авторизация → challenge page | Кнопки голосования активны |
| 12.9 | Голосование: гость | Без авторизации → challenge page | "Войдите, чтобы голосовать" |
| 12.10 | Голосование: проголосовать | Клик на кнопку → RPC cast_battle_vote | Toast "Голос принят!", % обновляется |
| 12.11 | Голосование: повторно | Попытка проголосовать ещё раз | "Ваш голос" (кнопки disabled) |
| 12.12 | Голосование: авто-закрытие | Текущее время >= дата/время матча | "Голосование закрыто" + кнопки disabled |
| 12.13 | Голосование: "до" показ | Голосование ещё открыто | "Голосование открыто до 25.03 18:00" |
| 12.14 | H2H: история встреч | Challenge page с матчами | Таблица предыдущих встреч |
| 12.15 | Score: результат | Матч завершён | Счёт по сетам + "Победитель: ..." + % угадали |
| 12.16 | TG: inline кнопки | Анонс в TG группе | 2 кнопки (🔴 Игрок1 / 🔵 Игрок2) + "Подробнее" |
| 12.17 | TG: голосование | Нажать inline кнопку в TG | "✅ Голос за ... принят!", кнопки обновляются с % |
| 12.18 | TG: повторное голосование | Нажать кнопку после голосования | "✅ Вы уже проголосовали!" |
| 12.19 | Кросс-проверка: TG→сайт | Проголосовать в TG → попытка на сайте | "Вы уже голосовали в Telegram!" |
| 12.20 | Кросс-проверка: сайт→TG | Проголосовать на сайте → попытка в TG | "✅ Вы уже голосовали на сайте!" |
| 12.21 | Admin: опубликовать баттл | Админка → Challenges → Опубликовать | Модалка с title + banner, анонс в TG |
| 12.22 | Admin: broadcast | Админка → Challenges → 📢 Отправить | TG отправлен, статус "✅ Отправлено" |
| 12.23 | Admin: ввести счёт | Админка → Challenges → Ввести счёт | Модалка сетов, auto-winner, сохранение |
| 12.24 | Admin: модалка закрытие | Сохранить счёт → модалка | Модалка закрывается при успехе |
| 12.25 | Admin: удалить баттл | Админка → Challenges → 🗑 | Подтверждение → удаление из БД |
| 12.26 | Admin: кликабельный title | Клик на название баттла | Открывается challenge.html в новой вкладке |
| 12.27 | 3 языка: challenge page | RU/EN/KG версии challenge.html | Labels на каждом языке корректны |
